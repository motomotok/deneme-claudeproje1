# Play Store Mağaza Listesi — Kopyala/Yapıştır Metinleri

Bu dosyadaki metinleri Play Console → "Store presence" → "Main store listing"
alanlarına doğrudan kopyalayabilirsin. Karakter sınırları Google'ın kendi
sınırlarıdır, altlarında kalındığından emin oldum.
...
🎮 NASIL OYNANIR
Ekran ikiye bölünür: sağ tarafa dokun → dış halkaya geç, sol tarafa
...
İnternet bağlantısı olmadan da oynayabilirsin, tüm ilerleme cihazında
saklanır.
...
- Ekran görüntüleri (telefon): `store-assets/screenshot-*.png`
